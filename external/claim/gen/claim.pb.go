...
type GetClaimResponse struct {
	...
	Data *ClaimInfo `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *GetClaimResponse) GetData() *ClaimInfo {
	if x != nil {
		return x.Data
	}
	return nil
...
type ClaimInfo struct {
	...
	Status Claim_StatusType `protobuf:"varint,3,opt,name=status,proto3,enum=claim.Claim_StatusType" json:"status,omitempty"`
}
...
func (x *ClaimInfo) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *ClaimInfo) GetStatus() Claim_StatusType {
	if x != nil {
		return x.Status
	}
	return Claim_UNKNOWN
...
var file_claim_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x74, 0x79, 0x22, 0x21, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x61, 0x69, 0x6d,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x38, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x43, 0x6c,
	0x61, 0x69, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6c, 0x61, 0x69,
	0x6d, 0x2e, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x22, 0x62, 0x0a, 0x09, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e,
...
var file_claim_proto_depIdxs = []int32{
	...
	15, // 11: claim.GetClaimResponse.data:type_name -> claim.ClaimInfo
